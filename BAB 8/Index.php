				...
				<div class="modal-dialog" onclick="event.stopPropagation()">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form>						<input type="hidden" name="category_id" id="category_id" value="">
					...
					<div class="modal-content">
						...
						<form action="transaction-proses.php" method="post">
							<div class="modal-body">
								...
								<div class="form-group">
									<label class="labelmodal" for="detail-harga" class="col-form-label">Harga :</label>						<input class="inputdata" type="text" name="detail-harga" class="form-control" id="detail-harga" readonly>
								</div>
								<h4>Pembeli</h4>
								<div class="form-group">
		...
		function bukaModal(categoryId) {
			...
			xhr.onreadystatechange = function() {
				if (xhr.readyState == 4 && xhr.status == 200) {
					...
					// Perbarui input tersembunyi			document.getElementById('category_id').value = categoryId;
